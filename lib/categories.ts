...
export const CATEGORY_SUBCATEGORIES: Record<string, string[]> = {
  Vehicles: ["Cars", "SUVs & Crossovers", "Motorbikes & Scooters", "Trucks & Lorries", "Buses & Vans", "Heavy Machinery", "Vehicle Parts", "Tires & Wheels", "Vehicle Accessories", "Boats & Watercraft", "Bicycles", "Vehicle Services", "Other"],
  "Real Estate": [
  ...
  "Mobile Devices": ["Smartphones", "Feature Phones", "Tablets", "Smartwatches", "Mobile Accessories", "Mobile Spare Parts", "Power Banks", "Phone Chargers & Cables", "Other"],
  "Computing & Electronics": ["Laptops", "Desktop Computers", "Computer Accessories", "Networking Equipment", "Printers & Scanners", "Software", "Computer Components", "Storage Devices", "Other"],
  "TV & Audio Systems": ["Televisions", "Home Theater Systems", "Speakers", "Headphones", "DVD & Media Players", "Projectors", "TV Boxes & Receivers", "Other"],
  "Home, Furniture & Appliances": ["Living Room Furniture", "Bedroom Furniture", "Office Furniture", "Kitchen Appliances", "Home Appliances", "Home Decor", "Garden Supplies", "Kitchenware", "Lighting & Electrical", "Other"],
  "Clothing & Fashion": ["Men's Clothing", "Women's Clothing", "Shoes & Footwear", "Bags & Backpacks", "Watches", "Jewelry", "Accessories", "Children's Clothing", "Wedding Wear & Accessories", "Other"],
  "Beauty & Personal Care": ["Skincare", "Haircare", "Makeup", "Fragrance", "Body Care", "Men's Grooming", "Beauty Tools & Accessories", "Other"],
  [CONSTRUCTION_MACHINERIES_REPAIRS_CATEGORY]: ["Materials", "Heavy Machinery", "Tools & Equipment", "Services", "Electrical & Plumbing Services", "Other"],
  Services: ["Repair & Maintenance", "Construction", "Cleaning Services", "Moving & Delivery Services", "Beauty Services", "IT & Tech Services", "Event Services", "Consulting", "Automotive Services", "Home Tutors", "Domestic Help Services", "Other"],
  "Commercial Equipment": ["Industrial Equipment", "Manufacturing Tools", "Store Equipment", "Restaurant Equipment", "Safety & Security Equipment", "Medical Equipment", "Other"],
  "Leisure & Hobbies": ["Sports Equipment", "Musical Instruments", "Books & Games", "Camping & Outdoor Gear", "Arts & Crafts", "Other"],
  "Kids & Baby Items": ["Baby Products", "Toys & Games", "Kids Clothing", "School Supplies", "Strollers & Car Seats", "Maternity Items", "Other"],
  "Agriculture & Farming": ["Farm Machinery", "Livestock", "Seeds & Fertilizers", "Agricultural Tools", "Feeds, Supplements & Agro Chemicals", "Other"],
  "Pets & Animals": ["Dogs & Puppies", "Cats & Kittens", "Birds", "Fish", "Pet Accessories", "Pet Food", "Other"],
  "Jobs & Employment": ["Accounting & Finance", "IT & Technology", "Sales & Marketing", "Customer Service", "Driving Jobs", "Construction Jobs", "Healthcare Jobs", "Hospitality & Hotel Jobs", "Other"],
